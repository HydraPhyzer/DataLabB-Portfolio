...
const Hero = () => {
  return (
    <div className="md:h-max h-[60vh] flex flex-col items-center justify-center relative overflow-hidden border-b-[1px] border-gray-400">
      <div className="max-w-4xl pb-2 md:pt-32">
